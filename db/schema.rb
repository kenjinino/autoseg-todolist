...
ActiveRecord::Schema.define(:version => 20130429235551) do
  ...
  add_index "bookmarks", ["todolist_id"], :name => "index_bookmarks_on_todolist_id"
  add_index "bookmarks", ["user_id", "todolist_id"], :name => "index_bookmarks_on_user_id_and_todolist_id", :unique => true
